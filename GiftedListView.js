...
class GiftedListView extends React.Component {
  ...
  paginationFetchingView() {
    ...
    return (
      <View
        style={[
          this.defaultStyles.paginationView,
  ...
  paginationAllLoadedView() {
    ...
    return (
      ...
      >
        <Text
          style={[
            this.defaultStyles.actionsLabel,
  ...
  emptyView(refreshCallback) {
    ...
    return (
      ...
      >
        <Text
          style={[
            this.defaultStyles.defaultViewTitle,
  ...
  _renderPaginationView() {
    if (
      ...
      (this.state.paginationStatus === "firstLoad" &&
        this.props.firstLoader === true)
    ) {
      return this.paginationFetchingView();
    } else if (
      this.state.paginationStatus === "waiting" &&
      this.props.pagination === true &&
      Object.values(this._getRows()).length > 0
    ) {
  ...
  render() {
    return (
      <ListView
        ...
        refreshControl={
          this.props.refreshable === true ? this.renderRefreshControl() : null
        }
        {...this.props}
